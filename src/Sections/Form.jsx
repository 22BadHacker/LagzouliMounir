...
const Form = () => {
  ...
  return (
    <div id='getInTouch' className='w-full relative overflow-hidden rounded-3xl shadow-md border-[.5px] border-black/20 backdrop-blur-[10px] h-auto flex flex-col p-4 items-center md:p-8 lg:p-10 gap-4'>
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-8 gap-6 lg:gap-10">
          ...
          <div className="flex flex-col gap-1">
              <label className='text-[16px] text-black/80 font-open-sans'>First name</label>
          ...
          <div className="flex flex-col gap-1">
              <label className='text-[16px] text-black/80 font-open-sans'>Last name</label>
          ...
          <div className="flex flex-col gap-1">
              <label className='text-[16px] text-black/80 font-open-sans'>Phone Number</label>
          ...
          <div className="flex flex-col gap-1">
              <label className='text-[16px] text-black/80 font-open-sans'>Email</label>
          ...
          <div className="flex w-full flex-col gap-1">
              <label className='text-[16px] text-black.80 font-open-sans'>Your Message</label>
          ...
          <input type="submit" className='px-10 hover:bg-[#bd4027] font-open-sans cursor-pointer py-4 mt-3 bg-black text-white rounded-full w-fit'  value="Send Message" />
      </form>
    </div>
  )
}
