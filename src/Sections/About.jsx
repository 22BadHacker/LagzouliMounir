...
const About = () => {
  return (
    <div className='relative  shadow-[2px_2px_4px_-1px_rgba(0,0,0,0.1)] overflow-hidden w-full lg:h-[500px] md:h-[500px] sm:h-[500px] h-[490px] rounded-3xl'>
    <Effect />        
    <div className="flex w-full h-full md:px-5 px-4 lg:px-10 p-10 flex-col justify-between bg-[rgb(241,241,241,.4)]">
