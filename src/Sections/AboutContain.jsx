...
const AboutContain = () => {
  return (
    <div className='w-full h-auto  gap-6 o grid md:grid-cols-[1fr_.5fr] lg:grid-cols-[1fr_.5fr]'>
        <About />
        <div className='w-full h-[450px] md:h-full  lg:h-full relative overflow-hidden rounded-3xl'>
          <img src={Mounir} className='img  h-full w-full object-cover rounded-3xl  shadow-[2px_2px_4px_-1px_rgba(0,0,0,.2)]' alt="" />
